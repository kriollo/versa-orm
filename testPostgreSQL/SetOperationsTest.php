...
class SetOperationsTest extends TestCase
{
    ...
    public function testIntersectRemovesNonCommon(): void
    {
    ...
    public function testIntersectAllKeepsDuplicateOverlap(): void
    {
        $qb1 = new QueryBuilder(self::$orm, 'set_ops_a');
        $qb1->select(['value']);
        $qb2 = new QueryBuilder(self::$orm, 'set_ops_b');
    ...
    public function testExceptRemovesRightSide(): void
    {
        $qb1 = new QueryBuilder(self::$orm, 'set_ops_a');
        $qb1->select(['value']);
        $qb2 = new QueryBuilder(self::$orm, 'set_ops_b');
    ...
    public function testExceptAllKeepsResidualMultiplicities(): void
    {
        $qb1 = new QueryBuilder(self::$orm, 'set_ops_a');
        $qb1->select(['value']);
        $qb2 = new QueryBuilder(self::$orm, 'set_ops_b');
