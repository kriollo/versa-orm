...
/**
 * Tests para validación automática desde esquema de base de datos (SQLite).
 *
 * @group sqlite
 */
class SchemaValidationTest extends BaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Crear esquema necesario para los tests (Users)
        // Incluimos columnas 'age' y 'score' usadas en los tests de MySQL
        ...
        $this->orm->schemaCreate('users', [
            ...
            ['name' => 'score', 'type' => 'DECIMAL(10, 2)', 'default' => 0.0],
        ]);
    }
    ...
    public function test_get_table_validation_schema_basic(): void
    {
        ...
        try {
            ...
            // Si el driver de SQLite soporta la introspección correctamente, debería tener datos
            if (!empty($schema)) {
