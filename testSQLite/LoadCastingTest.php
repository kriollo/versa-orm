...
class LoadCastingTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        self::$orm->schemaCreate('load_cast_test', [
            ...
            ['name' => 'active', 'type' => 'INTEGER', 'nullable' => false, 'default' => 0], // SQLite usa INTEGER para boolean
            ['name' => 'created_at', 'type' => 'TEXT', 'nullable' => true], // SQLite usa TEXT para datetime
        ]);
