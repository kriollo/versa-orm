...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600">Agrega un nuevo usuario al sistema</p>
        </div>
    ...
    <div class="bg-white shadow rounded-lg p-6">
        <form method="POST" action="?action=user_create">
            <div class="space-y-6">
                ...
                <!-- Personalización -->
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4 mt-8">Personalización</h3>
                </div>

                <div>
                    <label for="avatar_color" class="block text-sm font-medium text-gray-700 mb-2">Color del avatar</label>
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-gray-600">Vista previa del avatar</span>
                        </div>
                    </div>
                    <p class="text-sm text-gray-500 mt-1">Este color se usará para el avatar del usuario en toda la aplicación</p>
                </div>
            ...
            <div class="flex items-center justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
                <a href="?action=users" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
                    Cancelar
                </a>
