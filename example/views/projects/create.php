...
<div class="max-w-2xl mx-auto">
    <div class="mb-8">
        <a href="?action=projects" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium mb-4">
            <i class="fas fa-arrow-left mr-2"></i>
            Volver a proyectos
        </a>

        <h1 class="text-3xl font-bold text-gray-900 mb-2">Crear Nuevo Proyecto</h1>
        <p class="text-gray-600">Configura los detalles de tu nuevo proyecto</p>
    </div>
        ...
        <form method="POST" class="p-6 space-y-6">
                ...
                <div class="flex flex-wrap gap-3" x-data="{ selectedColor: '<?= $_POST['color'] ?? '#3498db' ?>' }">
                    ...
                    <?php foreach ($colors as $color => $name): ?>
                        <label class="flex items-center cursor-pointer">
                            ...
                            <div class="w-8 h-8 rounded-full border-2 border-transparent hover:border-gray-300 transition-colors"
            ...
            <div x-data="{ previewName: '<?= htmlspecialchars($_POST['name'] ?? 'Nombre del Proyecto') ?>', previewColor: '<?= $_POST['color'] ?? '#3498db' ?>' }">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    <div class="p-4 bg-gray-50">
                        <p class="text-sm text-gray-600">Vista previa del proyecto</p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <div class="flex items-center space-x-3">
                    <a href="?action=projects" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                        Cancelar
                    </a>
