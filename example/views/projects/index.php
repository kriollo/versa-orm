                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <div class="flex -space-x-2">
                                <?php foreach (array_slice($members, 0, 3) as $member): ?>
                                    <div class="avatar border-2 border-white dark:border-gray-800" style="background-color: <?= htmlspecialchars($member['avatar_color']) ?>" title="<?= htmlspecialchars($member['name']) ?>">
                                        <?= strtoupper(substr($member['name'], 0, 2)) ?>
                                    </div>
                                <?php endforeach; ?>
                                <?php if (count($members) > 3): ?>
                                    <div class="avatar bg-gray-500 border-2 border-white dark:border-gray-800" title="<?= count($members) - 3 ?> más">
                                        +<?= count($members) - 3 ?>
                                    </div>
                                <?php endif; ?>
                            </div>
