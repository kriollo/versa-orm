...
class PHPCompatibilityCLI
{
     ...
     */
    private function runVersionSpecificTests(string $version): \VersaORM\Tests\Results\Report
    {
     ...
     */
    private function showSummary(\VersaORM\Tests\Results\Report $report): void
    {
     ...
     */
    private function generateReports(\VersaORM\Tests\Results\Report $report): void
    {
     ...
     */
    private function showRecommendations(\VersaORM\Tests\Results\Report $report): void
    {
    ...
    private function parseArguments(array $argv): void
    {
        for ($i = 1; $i < count($argv); $i++) {
            ...
            if ($arg === '--help' || $arg === '-h') {
                ...
                $format = substr($arg, 9);
                if (!in_array($format, ['json', 'html', 'both'])) {
