...
final class PdoEngineTest extends TestCase
{
    ...
    public function test_metrics_start_empty_and_record_hydration(): void
    {
        ...
        self::assertSame(3, $metricsAfter['objects_hydrated']);
        self::assertGreaterThanOrEqual(12.5, $metricsAfter['hydration_ms']);
    }
    ...
    public function test_record_hydration_fast_accumulates_and_calls_recordHydration(): void
    {
        ...
        self::assertSame(1, $after['hydration_fastpath_uses']);
        self::assertSame(5, $after['hydration_fastpath_rows']);
        self::assertGreaterThanOrEqual(7.2, $after['hydration_fastpath_ms']);
        // also accumulated in general hydration metrics
        self::assertSame(5, $after['objects_hydrated']);
        self::assertGreaterThanOrEqual(7.2, $after['hydration_ms']);
    }
    ...
    public function test_reset_metrics_clears_counts(): void
    {
        ...
        self::assertGreaterThan(0, $m['objects_hydrated']);

        PdoEngine::resetMetrics();

        $cleared = PdoEngine::getMetrics();
        self::assertSame(0, $cleared['objects_hydrated']);
        self::assertSame(0, $cleared['hydration_fastpath_uses']);
    }
}
